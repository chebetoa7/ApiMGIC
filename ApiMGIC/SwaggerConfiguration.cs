...
namespace ApiMGIC
{
    public class SwaggerConfiguration
    {
        ...
        /// </summary>
        public const string EndpointDescription = "MGIC API v1";
        ...
        /// </summary>
        public const string ContactName = "Core .NET swagger";

        public const string ContactUrl = "https://aspnetcore.readthedocs.io/en/stable/tutorials/web-api-help-pages-using-swagger.html";
        ...
        /// <para>Foo API</para>
        /// </summary>
        public const string DocInfoTitle = "MGIC API";
